...
CONTAINS
   ...
   PROCEDURE, PASS :: LENGTH => INTVECTORSIZE
   PROCEDURE, PASS :: DIM => INTVECTORDIM
...
CONTAINS
   ...
   PROCEDURE, PASS :: LENGTH => REALVECTORSIZE
   PROCEDURE, PASS :: DIM => REALVECTORDIM
...
! check vector length
FUNCTION INTVECTORDIM(VEC) RESULT(DIM)
IMPLICIT NONE
! parameters
CLASS(INTVECTOR), INTENT(IN) :: VEC
INTEGER :: DIM
...
! check vector length
FUNCTION REALVECTORDIM(VEC) RESULT(DIM)
IMPLICIT NONE
! parameters
CLASS(REALVECTOR), INTENT(IN) :: VEC
INTEGER :: DIM
